...
import { type AnchorHTMLAttributes, type ButtonHTMLAttributes, type ElementRef, type LegacyRef, type ReactNode, type Ref } from "react";
    ...
    compoundVariants: [
      {
        isGhost: false,
        foreground: "primary",
        className: "bg-accent hover:[&:not(:disabled)]:text-accent focus-visible:text-accent",
      },
      {
        isGhost: true,
        background: "primary",
        className: "hover:[&:not(:disabled)]:text-accent focus-visible:text-accent",
      },
      {
        isGhost: true,
        foreground: "primary",
        className: "text-accent before:bg-accent",
      },
      {
        isGhost: false,
        background: "primary",
      ...
      },
      {
        isGhost: false,
        foreground: "default",
        className: "bg-neutrals-50 hover:[&:not(:disabled)]:text-neutrals-50 focus-visible:text-neutrals-50",
      },
      {
        isGhost: true,
        background: "default",
